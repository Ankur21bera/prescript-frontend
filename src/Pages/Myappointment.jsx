...
//     // Show admin-cancelled popup if exists
//     const latestCancelled = updatedAppointments
//       .filter(
//         (a) =>
//           a.cancelled &&
//           a.cancelledBy === "admin" &&
//           !localStorage.getItem(`ack_${a._id}`)
//       )
...
//       if (localStorage.getItem(`ack_${appointmentId}`)) return;
...
//         <ModalHeader>Appointment Update</ModalHeader>
//         <ModalBody>
//           {popupData && (
//             <div className="space-y-2 text-center">
//               <p className="text-sm mb-2">{popupData.message}</p>
//               {popupData.doctorName && <p>Doctor: {popupData.doctorName}</p>}
//               {popupData.slotDate && <p>Date: {popupData.slotDate}</p>}
//               {popupData.slotTime && <p>Time: {popupData.slotTime}</p>}
